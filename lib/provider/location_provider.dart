...
class LocationProvider with ChangeNotifier {
  ...
  Position _position = Position(longitude: 0, latitude: 0, timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1, headingAccuracy: 0,altitudeAccuracy: 0);
  Position _pickPosition = Position(longitude: 0, latitude: 0, timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1, headingAccuracy: 0,altitudeAccuracy: 0);
  bool _loading = false;
    ...
    try {
      ...
      myPosition = Position(
        ...
        timestamp: DateTime.now(), accuracy: 1, altitude: 1, heading: 1, speed: 1, speedAccuracy: 1,
           headingAccuracy: 0,altitudeAccuracy: 0
      );
    }
    if(fromAddress) {
