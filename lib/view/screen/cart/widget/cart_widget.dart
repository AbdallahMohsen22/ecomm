            ...
            child: Slidable(
              ...
              child: Column(
                children: [
                  ...
                  cartModel!.if_qty_update! =='1' || cartModel!.if_price_update! =='1'? Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Row(children: [
                      cartModel!.if_qty_update! =='1' ? Expanded(child: Text(getTranslated('if_qty_update', context)!, maxLines: 1, overflow: TextOverflow.ellipsis,
                          style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                              color: Colors.red ))) : Container(),
                      cartModel!.if_price_update! =='1' ? Expanded(child: Text(getTranslated('if_price_update', context)!, maxLines: 1, overflow: TextOverflow.ellipsis,
                          style: textMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                              color: Colors.red))) : Container(),
                    ]),
                  ) : Container(),
