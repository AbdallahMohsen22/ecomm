                            ...
                            if(orderProvider.addressIndex == null && !widget.onlyDigital) {
                              ...
                              if(orderProvider.paymentMethodIndex != -1){
                                ...
                                showModalBottomSheet(context: context,
                                    ...
                                    builder: (c) =>   PaymentMethodBottomSheet(onlyDigital: widget.onlyDigital,));
                                showCustomSnackBar(getTranslated('choose_your_payment_method', context), context, isToaster: true);
                              }
                            }
                          },
                  ...
                  Expanded(
                    child: ListView(physics: const BouncingScrollPhysics(), padding: const EdgeInsets.all(0), children: [
                      ...
                      Container(
                        ...
                        child: TitleButton(image: Images.coupon, title: getTranslated('subscription', context),
