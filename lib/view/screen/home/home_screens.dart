...
import '../../basewidget/popup_banner_dialog.dart';
...
lunsh() async {
  await launchUrlString("whatsapp://send?phone=+201111752343");
}
  ...
  Widget build(BuildContext context) {
   ...
   return Scaffold(
          ...
          child: CustomScrollView(controller: _scrollController, slivers: [
              ...
              SliverToBoxAdapter(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  // Provider.of<SplashProvider>(context, listen: false).configModel!.brandSetting == "1"?
                  // const BrandView(isHomePage: false) : const SizedBox(),
     ...
     //   onPressed: () async {
     //     launchUrlString('https://api.whatsapp.com/send/?phone=+201117300731&text=Hello+there%21&type=phone_number&app_absent=0');
     ...
     //   backgroundColor: Color(0xFFFD6399),
     // ),
    );
  }
