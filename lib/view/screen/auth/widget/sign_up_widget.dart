              ...
              Container(
                  ...
                  Hero(
                    ...
                    child: CustomButton(onTap: (){
                      ...
                      String phoneControl = _phoneController.text.trim();
                      String phone = '';
                      if(phoneControl[0] == '0'){
                        phone = Provider.of<AuthProvider>(context, listen: false).countryDialCode + phoneControl.substring(1);
                      }else{
                        phone = Provider.of<AuthProvider>(context, listen: false).countryDialCode + phoneControl;
                      }
